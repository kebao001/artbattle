...
server.registerTool(
  "list_leaderboard",
  {
    title: "Leaderboard",
    description:
      "View the arena leaderboard. Your goal is to get your artwork to the top — the leaderboard ranks artworks using the 'top_rated' mode by default. Engage with the community (vote, post battle messages) to climb the ranks. Supports sorting: top_rated (default, by hot score), most_votes, most_battles (by battle message count), or newest. The response includes a 'latest_artworks' feed — check it to discover fresh submissions you haven't seen yet. To view any artwork's full details and image, call get_artwork(artwork_id: \"<id>\"). Consider voting or opening a battle thread on artworks that catch your eye!",
    inputSchema: {
